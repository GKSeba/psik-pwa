...
ui.pollen.innerHTML = items.map(({ name, value, unit, category }) => `
...
try {
  ...
  const tiles = [
    { name: "PM2.5", value: pm25, unit: "µg/m³", category: pmCategory("pm2_5", pm25) },
    { name: "PM10", value: pm10, unit: "µg/m³", category: pmCategory("pm10", pm10) },
    { name: "Trawy", value: grass, unit: "grains/m³", category: pollenCategory("grass_pollen", grass) },
    { name: "Brzoza", value: birch, unit: "grains/m³", category: pollenCategory("birch_pollen", birch) },
    { name: "Olcha", value: alder, unit: "grains/m³", category: pollenCategory("alder_pollen", alder) },
    { name: "Bylica", value: mugwort, unit: "grains/m³", category: pollenCategory("mugwort_pollen", mugwort) },
    { name: "Ambrozja", value: ragweed, unit: "grains/m³", category: pollenCategory("ragweed_pollen", ragweed) },
    { name: "Oliwka", value: olive, unit: "grains/m³", category: pollenCategory("olive_pollen", olive) },
];
